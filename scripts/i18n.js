...
const i18n = {
    'PL': {
        ...
        'audio_permission_request': 'Przeglądarka zablokowała automatyczne odtwarzanie dźwięku. Kliknij przycisk poniżej, aby zezwolić na odtwarzanie audio.',
        ...
        'error_action_missing_value': 'Błąd logiki: Akcja typu damage lub heal musi mieć zdefiniowaną wartość (value lub valuePerc)!',
        ...
        'error_effect_missing_flag': 'Błąd logiki: Efekt "{name}" nie posiada wymaganej flagi "isBeneficial" (wymaganej przy akcjach z wymuszonym rzutem)!',
    ...
    'EN': {
       ...
       'placeholder_no_rolls': 'Roll history is empty',
        ...
        'audio_permission_request': 'The browser blocked autoplaying audio. Click the button below to enable audio playback.',
        ...
        'error_action_missing_value': 'Logic Error: Damage or heal action must have a defined value (value or valuePerc)!',
        ...
        'error_effect_missing_flag': 'Logic Error: Effect "{name}" is missing the required "isBeneficial" flag (required for actions with forced rolls)!',
