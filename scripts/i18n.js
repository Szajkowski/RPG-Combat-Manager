...
const i18n = {
    'PL': {
        ...
        'error_armor_mixed_stats': 'Błąd logiki: Akcja pancerza dodaje i odejmuje statystyki naraz. Wymagana flaga "isActionBeneficial" w obiekcie akcji!',
        ...
        'error_condition_mixed': 'Błąd logiki: Akcja wymusza rzuty i posiada zarówno pozytywne, jak i negatywne stany. Wymagana flaga "isConditionSuccessBeneficial" na głównej akcji, aby określić jak liczyć szansę!',
    ...
    'EN': {
       ...
       'placeholder_no_rolls': 'Roll history is empty',
        ...
        'error_armor_mixed_stats': 'Logic Error: Armor action applies mixed stats (+ and -). Requires "isActionBeneficial" flag on the action object!',
        ...
        'error_condition_mixed': 'Logic Error: Action uses forced rolls and has mixed conditions (good and bad). Requires "isConditionSuccessBeneficial" flag on the action to determine success calculation focus!',
